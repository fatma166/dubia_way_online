...
use App\Models\Zone;
use App\Repositories\Admin\SingleRebo\OfferRepository;
...
class OfferController extends BaseController
{
    ...
    public function create()
    {
        ...
        $categories=Category::where('status',1)->where('restaurant_id',config('app.default_vendor'))->get();
        $places=Restaurant::where('status',1)->get();
        return view($this->view . '.create', compact('compilations','places','categories'));
    }
  ...
  $categories=Category::where('status',1)->where('restaurant_id',config('app.default_vendor'))->get();
        return view($this->view . '.edit', compact('record','compilations','places','categories'));
    }

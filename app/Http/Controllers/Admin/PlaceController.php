...
class PlaceController extends BaseController
{
    ...
    {
        $data=$this->repository->statistics();

       $places= parent::index($request, ['vendor','compilation'], ['foods'], '', 10, []);
        ...
        */
        return view($this->view . '.index', compact('places','data'));
    }
    ...
    public function create()
    {
        ...
        return view($this->view . '.create', compact('compilations','zones'));
    }
    ...
    public function edit($id)
    {
       // $governorates = Governorate::orderBy('name_' . app()->getLocale())->get();
        ...
        $record= parent::show($id,['vendor']);

        $zones=Zone::get();
        $compilations=Compilation::where('status',1)->get();
        return view($this->view . '.edit', compact('record','compilations','zones'));
    }

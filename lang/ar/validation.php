...
return [
    ...
    'accepted_if' => 'حقل :attribute يجب قبوله :other عندما :قيمة.',
    ...
    'different' => 'حقل :attribute و :other يجب أن تكون مختلف.',
    'digits' => 'حقل :attribute لا بد وأن :digits أرقام.',
    'digits_between' => 'حقل :attribute يجب ان يكون بين :min و :max أرقام.',
    ...
    'ends_with' => 'حقل :attribute يجب أن ينتهي بأحد following: :values.',
    'enum' => 'المختار :attribute غير صالح.',
    'exists' => 'المختار :attribute غير صالح.',
    'file' => 'حقل :attribute يجب أن يكون ملفًا.',
    'filled' => 'حقل :attribute يجب أن يكون للحقل قيمة.',
    'gt' => [
        'array' => 'حقل :attribute  :value العناصر.',
        'file' => 'حقل :attribute يجب أن يحتوي على أكثر من :value كيلوبايت.',
        'numeric' => 'حقل :attribute يجب أن يحتوي على أكثر من :value.',
        'string' => 'حقل :attribute يجب أن يحتوي على أكثر من :value احرف.',
    ],
    'gte' => [
        'array' => 'حقل :attribute يجب ان :value من العناصر أو أكثر.',
        'file' => 'حقل :attribute يجب أن يكون أكبر من أو يساوي :value كيلوبايت.',
        'numeric' => 'حقل :attribute يجب أن يكون أكبر من أو يساوي :value.',
        'string' => 'حقل :attribute يجب أن يكون أكبر من أو يساوي :value احرف.',
    ],
    ...
    'not_in' => 'حقل المختار :attribute غير صالح.',
    ...
    'prohibited_if' => 'حقل :attribute الحقل محظور عندما :other عندما :value.',
    'prohibited_unless' => ' :attribute الحقل محظور ما لم :other من بين  :values.',
    'prohibits' => 'حقل :attribute يحظر المجال :other من الوجود.',
    'regex' => 'حقل :attribute التنسيق غير صالح.',
    'required' => 'حقل :attribute مطلوب.',
    'required_array_keys' => 'حقل :attribute يجب أن يحتوي الحقل على إدخالات for: :values.',
    'required_if' => 'حقل :attribute الحقل مطلوب عندما :other تكون :value.',
    ...
    'required_without_all' => 'حقل :attribute الحقل مطلوبًا في حالة عدم وجود أي من :values حاضرون.',
    'same' => 'حقل :attribute و :other يجب أن تتطابق.',
    'size' => [
        'array' => 'حقل :attribute يجب أن يحتوي على :size.',
        'file' => 'حقل :attribute  يجب أن :size كيلوبايت.',
        'numeric' => 'حقل :attribute يجب أن يكون :size.',
        'string' => 'حقل :attribute يجب أن يكون :size احرف.',
    ],
    'starts_with' => 'حقل :attribute يجب أن تبدأ بأحد following: :values.',

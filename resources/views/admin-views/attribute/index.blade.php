        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{__('attribute')}} {{__('setup')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="input-label text--black" for="exampleFormControlInput1">{{ __('Attribute') }} {{__('name')}}</label>
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">{{__('attribute')}} {{__('list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$attributes->total()}}</span></h5>
                            ...
                            <div class="hs-unfold ml-3">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <span class="dropdown-header">{{__('download')}} {{__('options')}}</span>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th class="w-50p">{{__('name')}}</th>
                                <th class="w-20p">{{__('action')}}</th>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn" href="{{route('admin.attribute.edit',[$attribute['id']])}}" title="{{__('edit')}}"><i class="tio-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn--danger btn-outline-danger action-btn" href="javascript:" onclick="form_alert('attribute-{{$attribute['id']}}','Want to delete this attribute ?')" title="{{__('delete')}}"><i class="tio-delete-outlined"></i>
                                            </a>

    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">إضافة اعدادات</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <form action="{{route('admin.business_setting.store')}}" method="post"   enctype="multipart/form-data">
            @csrf
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="projectname" name="key"  value="{{old("key")}}" class="form-control" placeholder="ادخل هنا اسم الاعداد">
                                    @error("key")
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="projectname" name="value"  value="{{old("value")}}" class="form-control" placeholder="القيمه">
                                    @error("value")
                                    <span class="text-danger">{{ $message }}</span>
                                    @endError
                                </div>

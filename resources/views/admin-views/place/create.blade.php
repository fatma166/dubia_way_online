                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="mb-3">
                                <div class="mt-3">
                                    <input type="file"  value="{{old("image[]")}}" name="image[]" data-plugins="dropify" data-max-file-size="3M"  class=" @error("image") is-invalid @endError"  />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="minimum_order"  value="{{old("minimum_order")}}" id="projectname" class="form-control @error("minimum_order") is-invalid @endError" placeholder="كمثال :٣٤">
                                @error("minimum_order")
                                <span class="text-danger">{{ $message }}</span>
                                @endError
                            </div>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-3">
                                <div class="mt-3">
                                    <input type="file"  name="cover_photo[]"  value="{{old("cover_photo[]")}}" data-plugins="dropify" data-max-file-size="3M" />
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="lat"  name="latitude" class="form-control  @error("latitude") is-invalid @endError"   value="{{old("latitude")}}"placeholder="اكتب هنا خط العرض">
                                @error("latitude")
                                <span class="text-danger">{{ $message }}</span>
                                @endError
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" id="lng" name="longitude" class="form-control  @error("longitude") is-invalid @endError" value="{{old("longitude")}}" placeholder="اكتب هنا خط الطول">
                                @error("longitude")
                                <span class="text-danger">{{ $message }}</span>
                                @endError
                            </div>

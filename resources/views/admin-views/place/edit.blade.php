                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control  @error("delivery_time_unit") is-invalid @endError" name="delivery_time_unit"  value="{{$record->delivery_time_unit}}"data-toggle="select2" data-width="100%">
                                                <option value="minutes" @if($record->delivery_time_unit=="minutes") selected @endif>دقائق</option>
                                                <option value="hours" @if($record->delivery_time_unit=="hours") selected @endif>ساعات</option>
                                            </select>

                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap table-striped" id="products-datatable">
                            ...
                            <tr>
                                ...
                                <td> @php echo( \App\Models\Food::where('restaurant_id',($place->id))->count());@endphp</td>
                                <td>@php echo( \App\Models\Order::where('order_status','delivered')->where('restaurant_id',$place->id)->sum('order_amount'));
                                    @endphp</td>
                                <td>

...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">تعديل منطقه </h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            <form action="{{route('admin.zone.update',['id'=>$zone->id])}}" method="post" id="zone_form"   enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input id="zone_name" type="text" name="name" class="form-control"   value="{{$zone->name}}"  placeholder="اسم المنطقه">
                                ...
                                <div class="form-group mb-3" style="display: none">
                                    ...
                                    <textarea  type="text"  style="display:none" name="coordinates"  id="coordinates" class="form-control">@foreach($zone->coordinates[0] as $key=>$coords)<?php if(count($zone->coordinates[0]) != $key+1) {if($key != 0) echo(','); ?>({{$coords->getLat()}}, {{$coords->getLng()}})<?php } ?>@endforeach
                                </textarea>
                                </div>
                               <div class="mb-3">

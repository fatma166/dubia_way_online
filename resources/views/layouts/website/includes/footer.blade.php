...
<li class="menu-item">
    ...
    <a href="https://wa.me/{{ $data['place']['phone'] }}" target="_blank">
        <img src="{{asset('website/assets/images/whatsapp-icon.png')}}" alt="Chat on WhatsApp" style="width: 24px; height: 24px; vertical-align: middle;" loading="lazy">
                ...
                <div class="box-footer col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="stelina-custommenu default">
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('privacy.policy') }}">{{__('Privacy & Return Policy')}}</a>
                            </li>
                        </ul>
                    </div>
                </div>

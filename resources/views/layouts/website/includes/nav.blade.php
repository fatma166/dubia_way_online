                ...
                <div class="col-lg-3 col-sm-4 col-md-3 col-xs-7 col-ts-12 header-element">
                    <div class="logo">
                        <a href="{{route('home.index')}}">
                            <img src="{{asset('website/assets/images/DubaiWay.png')}}" alt="Dubai Way" style="width: 210px;padding-top: -15px;margin-top: -57px;" loading="lazy">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="container-wapper">
                        <ul class="stelina-clone-mobile-menu stelina-nav main-menu " id="menu-main-menu">
                           ...
                           <!-- <li class="menu-item  menu-item-has-children item-megamenu">
                            ...
                            <li class="menu-item">
                                  <a href="{{ route('privacy.policy') }}" class="stelina-menu-item-title">{{__('Privacy & Return Policy')}}</a>
                            </li>
...
<div class="header-device-mobile">
    <div class="wapper">
        <div class="item mobile-logo">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('website/assets/images/DubaiWay.png')}}" alt="Dubai Way" style="width: 11rem;" loading="lazy">
                </a>
            </div>
        </div>
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    const languageToggle = document.querySelector('.header-language .language-toggle');
    const languageSubmenu = document.querySelector('.header-language .stelina-submenu');

    if (languageToggle && languageSubmenu) {
        languageToggle.addEventListener('click', function(event) {
            event.preventDefault(); // Prevent the default anchor behavior
            const isVisible = languageSubmenu.style.display === 'block';
            languageSubmenu.style.display = isVisible ? 'none' : 'block'; // Toggle the display
        });

        // Close the dropdown if clicking outside
        document.addEventListener('click', function(event) {
            const isClickInside = languageToggle.closest('.stelina-language').contains(event.target);
            if (!isClickInside) {

			 ...
			 <li class="menu-item">
                    ...
                    <span class="menu-icon">
                      <i data-feather="percent"></i>
                        ...
                        <span class="menu-text"> عروض</span>
                    </a>
                </li>
            @endif
            @if (\App\Modules\Core\Helper::module_permission_check('places'))
                <li class="menu-title">اداره انواع المنتجات</li>
                <li class="menu-item">
                    <a href="{{route('admin.attribute.add-new')}}" class="menu-link">
                    <span class="menu-icon">
                      <i data-feather="briefcase"></i>
                    </span>
                        <span class="menu-text"> ادارة الانواع</span>
                    </a>
                </li>

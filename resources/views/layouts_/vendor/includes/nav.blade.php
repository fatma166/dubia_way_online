<!-- ========== Topbar Start ========== -->
<div class="navbar-custom" style="background: #ad9173 !important">
    <div class="topbar">
        ...
        <ul class="topbar-menu d-flex align-items-center">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle waves-effect waves-light arrow-none" href="{{route('vendor.order.index')}}" role="button" aria-haspopup="false" aria-expanded="false">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                    <!-- item-->
                    <a href="{{route('vendor.employee.edit',['id'=>\Illuminate\Support\Facades\Auth::guard('vendor')->user()->id])}}" class="dropdown-item notify-item">

...
<header class="header style7">
    <style>
    /* تغميق خلفية القوائم الرئيسية والجانبية بدون التأثير على الوظائف */
    .header-nav-container, .header-nav-wapper, .header-nav, .main-menu-wapper, .vertical-wapper.block-nav-categori, .stelina-nav-vertical.vertical-menu, .main-menu {
        background: #ab8e66;
        box-shadow: 0 2px 12px #ab8e6610;
    }
                ...
                <div class="col-lg-3 col-sm-4 col-md-3 col-xs-7 col-ts-12 header-element">
                    <div class="logo">
                        <a href="{{route('home.index')}}">
                            <img src="{{asset('website/assets/images/DubaiWay.png')}}" alt="img" style="width: 210px;padding-top: -15px;margin-top: -57px;">
                        </a>
                    </div>
                </div>
...
<div class="header-device-mobile">
    <div class="wapper">
        <div class="item mobile-logo">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('website/assets/images/DubaiWay.png')}}" alt="img" style="11rem !important">
                </a>
            </div>
        </div>

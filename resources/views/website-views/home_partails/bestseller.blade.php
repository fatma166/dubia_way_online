                    ...
                    <div class="product-thumb">
                        <div class="thumb-inner">
                            <a href="{{route('products.details',$product['id'])}}">
                                <img src="{{asset($product['image'])}}" onerror="this.onerror=null;this.src='{{asset('website/assets/images/DubaiWay.png')}}'" alt="{{$product['name']}}" class="mobile-img" style="width:300px;height:300px;">
                            </a>

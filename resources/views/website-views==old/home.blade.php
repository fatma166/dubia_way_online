...
<div class="home-slider style1 rows-space-30">
    <div class="container" dir="ltr">
        ...
        <div class="banner-wrapp rows-space-35">
            <div class="container">
                <div class="row">
  <div class="mobile-only" style="border: 1px solid black; padding: 1rem; "><!--margin-top: .5rem !important;-->
    ...
    <a href="{{ route('products.list') }}">
        <button class="button btn-cart-to-checkout" id="checkout" style="background: #d78b07 !important; font-size: x-large; padding: 2rem;">
            {{ __('Show More') }}
        </button>
    </a>
</div>
